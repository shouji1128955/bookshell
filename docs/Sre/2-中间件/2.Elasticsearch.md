...
![](http://images.zlqit.com/bookshell/operator/m_bb053d409437a74a57f4939a31835e20_r.png)

![](http://images.zlqit.com/bookshell/operator/m_bb053d409437a74a57f4939a31835e20_r.png)

启动之后过一段时间报错：找不到节点
![](http://images.zlqit.com/bookshell/operator/m_ea9f34a30c3fdb68dcaebda54a1ade40_r.png)
按照上面方式，首先但节点启动集群，如果其他节点没有启动，首先会有图1的提示，过一段时间会有图2提示连接不到节点。 

然后启动第二个节点
然后在节点1看日志，显示已经有一个节点加进来 ，显示主节点已更改，当前是es002

![](http://images.zlqit.com/bookshell/operator/m_49526a6d7e4ae7e4df3f680ce2f64626_r.png)
日志提示：
...
然后在es003加入第三个节点： 
在es001上看到的日志
![](http://images.zlqit.com/bookshell/operator/m_71a499c460edb7a07fb3821a08ceee1c_r.png)
在es002上看到的日志

es002为主节点
![](http://images.zlqit.com/bookshell/operator/m_1a0cc3e5b76c5ee4b02b351dbd7f4d1d_r.png)
查看集群状态：
![](http://images.zlqit.com/bookshell/operator/m_9a4330a8494853119feb1088f2a415d0_r.png)
...
![](http://images.zlqit.com/bookshell/operator/m_6efbc75e6bce3a032d948c9c008bcf9a_r.png)
查看所有的索引：
![](http://images.zlqit.com/bookshell/operator/m_7c5f8a212ef4ceeba5a69650b86d27ac_r.png)''

删除索引：
![](http://images.zlqit.com/bookshell/operator/m_6c73efe34c9fb98b91b6d89f96d7670c_r.png)

2、添加数据 doc  文档
在新版本中没有type概念，就是没有表的概念。 

![](http://images.zlqit.com/bookshell/operator/m_c408ddf36ec47598299db76d3156c3d2_r.png)

以上_id是自动生成的。也可以自定义，通过下面的方式。

![](http://images.zlqit.com/bookshell/operator/m_9ec589505ac2ba76cf66d41576000514_r.png)
![](http://images.zlqit.com/bookshell/operator/m_0d64d766ad5006f73c29f4398ecf5892_r.png)
操作记录
...
![](http://images.zlqit.com/bookshell/operator/m_a46f00cbf5e65487f0bc6ab8e99fb31a_r.png)

查询所有的索引文档
![](http://images.zlqit.com/bookshell/operator/m_86d5aa3a2415377072935a07f7b73f99_r.png)
修改全部数据
![](http://images.zlqit.com/bookshell/operator/m_2b6bcfddcb7c9c0c342ba0267d9c1c97_r.png)
修改局部数据
![](http://images.zlqit.com/bookshell/operator/m_977b59a5a64246385effeb8f880a0c58_r.png)

cur /_cat/nodes  #查看节点

es默认是一个分片，一个副本。

![](http://images.zlqit.com/bookshell/operator/m_982df7c7b25ee1624aff3ca0a3ec95c5_r.png)
一些说明： 
![](http://images.zlqit.com/bookshell/operator/m_b99901484bd6f55da40f095194c5bd19_r.png)
...
![](http://images.zlqit.com/bookshell/operator/m_b4bc53f40d2ecc53780e3f3c2dd233c3_r.png)
...
![](http://images.zlqit.com/bookshell/operator/m_a1ec268b5c670e3703315e69f3ad9a41_r.png)
