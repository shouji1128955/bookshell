...
![](images/m_0bf0b5ce614a95462dbe02a787f4a241_r.png)


![](images/m_9f440950ac288db18fda6be27ac83027_r.png)
...
根据报警处理
![](images/m_f1e5684549bcb3df81a80f0fccd80c73_r.png)
...
![](images/m_9a8167c7c5c7ebe63461b36c4828b40a_r.png)

多核CPU，不同的核通过L2 cache进行通信，存储和外设通过总线与CPU通信，如下：
![](images/m_9566b09a75e58847ce3c2b581a8643f9_r.png)

多核超线程,每个核有两个逻辑的处理单元，两个核共同分享一个核的资源，如下：

![](images/m_83435ef66662d4c25b44aaa94c64fadb_r.png)
...
![](images/m_5e2632884e13b169810ea17122898a2a_r.png)
...
3.故障状态：
![](images/m_8a4ba1934092b0c6cb3ca3554c760b2d_r.png)

![](images/m_c37feb12bd3ee434f37c6a9ed64e0ea9_r.png)
备注：注意中间读取的是sda3失败
...
![](images/m_d0e503279caf0052f9b5abdc89133144_r.png)
...
```
![](images/m_1a286e4ba2305fd70d658e7fca435ff4_r.png)
...
![](images/m_65ce013e29f8dddafc75cb2c2ceea500_r.png)

2、jenkins dockerfile报错
![](images/m_613f8dfb61dfa35a69f852582e9eb030_r.png)
正确写法1; 
...
#### 13、docker重载
![](images/m_5001693abb69be42c4c38cd464a02295_r.png)

![](images/m_4c3f65f1b117c2cbc9f0e0bd0e763565_r.png)
...
```
![](images/m_4c0962eb6c3565bd8dfe8464b9140a99_r.png)
...
#### 1、错误告警
![](images/m_a92a812c3871ad10e83ad752cdf808d3_r.png)
说明：此图在桌面文件架构图当中 

#### 2、跨域的配置
![](images/m_3dd396d1379a4448c5aba339669e8cd8_r.png)
...
方式1验证： 通过slb代理访问
![](images/m_e4d80ec8fdc5ee934d985ee974768fdc_r.png)

方式2验证： 通过直接访问代理端的机器 
![](images/m_229024d09585bd38489db35df1799e00_r.png)
...
![](images/m_424f48244928babdd25893b400829a9e_r.png)
...
![](images/m_2ca182f7c916d490a1c1e09b1cc7e3a7_r.png)

![](images/m_43952c46bbdf982da5460dd2a97fc598_r.png)
...
![](images/m_46471e1c82506feb1d707d5ef712ca94_r.png)
...
![](images/m_f622401cba6ef30fca3c19c05b23a63b_r.png)
...
![](images/m_8679fd475da6b9b889f7cf9dc0108be7_r.png)

尝试使用umount取消挂载但是会卡住不动
当有别的程序正在访问挂载的文件时，也会提示卸载失败，通过 lsof /xxx 查看是哪个进程占用了/xxx,kill -9 $pid ,然后再卸载，进程少的时候这个方便一些，一旦进程量过大就不方便了
![](images/m_83c53144f27734518b5e7c1dda25fb26_r.png)
加参数 -f 也会报错
![](images/m_6d4a1a90ae299a0e6f7574b8725ce74b_r.png)
...
```
测试df -h命令是否恢复正常
![](images/m_f517eeb6374fef1ee8de2f59032b0622_r.png)
...
图1
![](images/m_4a2bc7458996621d99460dbc7f01b995_r.png)

图2
![](images/m_11b5495547a7fe216a58e8249cc715a0_r.png)
...
![](images/m_f385fd02c12ced0eaf114604730a2de0_r.png)

输入命令下载安装choco install mongodb-compass

默认安装目录是C:\Program Files下打卡程序

![](images/m_b4d44aa6cf5c9a2727f56e175f2a4159_r.png)
...
然后参考下面进行操作即可
![](images/m_4621882df1f186f334aea582a03c3943_r.png)
...
![image-20231130183055043](images/image-20231130183055043.png)
