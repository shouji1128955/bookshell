...
4、元数据目录metadata(里面的软连接也需要，需要tar打包，否则失败)

5、实际的建表目录，这个需要查到metadata下面的数据库对应的软连接目录给打包到新节点



集群需要使用的域名映射的方式部署的，也就是不能通过ip来做的，如果是节点ip做的话，zookeeper元数据上的replicas下没法对应 上，可能会有其他的问题，应该也可以通过命令来修复zookeeper的元数据
...
这里是迁移/data/container/clickhouse/data/metadata/ 目录下的软链接对于的store数据目录文件

metadata目录： 类似下面这样，有sql文件和软链接文件，此处我们做的是同步软链接文件

在 /data/container/clickhouse/data/metadata下，可以看到如下结构

![image-20231225002807486](images/image-20231225002807486.png)
...
![image-20231224150940700](images/image-20231224150940700.png)
...
这里是迁移/data/container/clickhouse/data/metadata/ 目录下的sql文件
...
![image-20231225002910073](images/image-20231225002910073.png)
...
备注: data目录里面是每个库的文件夹，每个文件夹都包含了软链接到store目录下，我们不需要关注这些，当我们的元数据同步后，数据默认是自动创建的，当然,system系统库是自动生成的。



![image-20231225003122522](images/image-20231225003122522.png)
...
，VLOOKUP生成比对， 主要是比对迁移前后数据库的是否一样





![](./images/img-2023-12-24-320.gif)
...
![image-20231224152832117](images/image-20231224152832117.png)
...
![image-20231224152958677](images/image-20231224152958677.png)
...
![image-20231224153152598](images/image-20231224153152598.png)
...
![image-20231224153402785](images/image-20231224153402785.png)
...
![image-20231224235612428](images/image-20231224235612428.png)
...
![image-20231224160436669](images/image-20231224160436669.png)
...
![image-20231224160528306](images/image-20231224160528306.png)

报错提示2：

![image-20231224160743002](images/image-20231224160743002.png)
...
![image-20231224160948656](images/image-20231224160948656.png)
...
![image-20231224161034365](images/image-20231224161034365.png)
...
![image-20231224161204081](images/image-20231224161204081.png)
...
![image-20231224161938309](images/image-20231224161938309.png)
...
![image-20231224163312594](images/image-20231224163312594.png)
...
![image-20231224163852066](images/image-20231224163852066.png)
...
![image-20231224163803248](images/image-20231224163803248.png)
...
![image-20231224234431697](images/image-20231224234431697.png)
...
![image-20231224204346121](images/image-20231224204346121.png)
...
![image-20231224232741770](images/image-20231224232741770.png)
...
![image-20231224232827679](images/image-20231224232827679.png)
